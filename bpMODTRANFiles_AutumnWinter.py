...
# consider the daylight saving time for EST
# Jan 1 ~ March 9, Nov 3 ~ Dec: GMT-5
# March 10 ~ Nov 2: GMT-4
...
days = list(range(1,79))+ list(range(266, 366))
GMTtimes = range(2,24,2)  # 2, 6, 10, 14, 18, 22 for the same day  #time = [x-4 if x > 4 else x+20 for x in GMTtimes] # 22, 2, 6, 10, 14, 18
